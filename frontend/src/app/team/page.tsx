...
const Team = (props: Props) => {
  return (
    <div className="mb-16">
      <div className="container flex justify-center mx-auto pt-16 text-gray-700">
        <div>
      ...
      <div className="w-full bg-gray-800 px-10 pt-10">
        <div className="container mx-auto">
          <div
            ...
            className="lg:flex md:flex sm:flex items-center  flex-wrap md:justify-around sm:justify-around lg:justify-around"
          >
            <div
              role="listitem"
              ...
              <div className="rounded overflow-hidden shadow-md bg-white text-gray-700">
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    ...
                    <a href="https://www.linkedin.com/in/milad-khadem-9a027a76/?originalSubdomain=de" target="_blank"> 
            ...
            >
              <div className="rounded overflow-hidden shadow-md bg-white">
                <div className="absolute -mt-20 w-full flex justify-center">
                  <div className="h-32 w-32">
                    <img
                      src="https://media.licdn.com/dms/image/D4E03AQEi4OH1Q0cRUg/profile-displayphoto-shrink_200_200/0/1689263001729?e=1694649600&v=beta&t=oO_76Rb72dP_Gpd47QDs4gfpXOICooHkncI7ZNxzsNM"
                ...
                <div className="px-6 mt-16">
                  ...
                  <div className="w-full flex justify-center pt-5 pb-5">
                    ...
                    <a
                      href="https://www.linkedin.com/in/djawid-nezami/"
                      className="mx-5"
                    >
                        <a href="https://www.linkedin.com/in/djawid-nezami/" target="_blank"> 
