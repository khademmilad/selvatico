...
const Register = (props: Props) => {
  ...
  <div className="container px-4 mx-auto">
    <div className="max-w-3xl mx-auto">
      ...
      <p className="mb-16 text-xl text-white tracking-tight">Enjoy the free capabilities of our Product!</p>
      <form className="flex flex-wrap -m-3" action="#">
        ...
        <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem] ">
                ...
                <span>I agree to the </span> <a className="text-white hover:text-gray-200" href="#">Terms &amp; Conditions &amp; Privacy Policy</a>
                  </label>
                </div>
        </div>
        <div className="w-full p-3">
          <a className="inline-block mb-7 px-5 py-4 w-full text-white text-center font-semibold tracking-tight bg-indigo-500 hover:bg-indigo-600 rounded-lg focus:ring-4 focus:ring-indigo-300 transition duration-200" href="#">Create Free Account</a>
          <span className="font-medium text-white tracking-tight">
            <span>Already have an account?</span>
            <Link className="text-red-500 hover:text-red-700 transition duration-200" href="login"> Sign In</Link>
          </span>
        </div>
      </form>
    </div>
